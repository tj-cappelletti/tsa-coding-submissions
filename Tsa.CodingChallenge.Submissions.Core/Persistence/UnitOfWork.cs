...
namespace Tsa.CodingChallenge.Submissions.Core.Persistence
{
    public class UnitOfWork : IUnitOfWork, IDisposable
    {
        ...
        public IRepository<Submission> SubmissionsRepository { get; }

        public IRepository<TeamMember> TeamMembersRepository { get; }

        public IRepository<TestDataSetElement> TestDataSetElementsRepository { get; }

        public IRepository<TestDataSet> TestDataSetsRepository { get; }
        ...
        public UnitOfWork(SubmissionsEntitiesContext context)
        {
            ...
            SubmissionsRepository = new Repository<Submission>(_context);
            TeamMembersRepository = new Repository<TeamMember>(_context);
            TestDataSetElementsRepository = new Repository<TestDataSetElement>(_context);
            TestDataSetsRepository = new Repository<TestDataSet>(_context);
        }
